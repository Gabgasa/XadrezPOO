...
public class Peao extends Peca 
{
	...
	public Vector<Pair<Integer, Integer>> possiveisMovimentos() 
	{
		...
		if(destino.getFirst()>=0 && destino.getFirst()<=7 && destino.getSecond()<=7 && destino.getSecond()>=0 && tabuleiro.getPeca(destino)!=null && tabuleiro.getPeca(destino).getJogador()!=jogador)
		...
		if(destino.getFirst()>=0 && destino.getFirst()<=7 && destino.getSecond()<=7 && destino.getSecond()>=0 && tabuleiro.getPeca(destino)==null)
			jogadas.add(new Pair<>(destino.getFirst(), destino.getSecond()));
